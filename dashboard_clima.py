...
# Estilos CSS (Pegado a la izquierda para evitar errores)
st.markdown("""
<style>
...
# -----------------------------------------------------------------------------
# 2. ENCABEZADO (HTML PEGADO A LA IZQUIERDA - SOLUCIÓN DEL TEXTO RAW)
# -----------------------------------------------------------------------------
...
def cargar_datos():
    try:
        ...
        # --- AQUÍ ESTABA EL ERROR DE SINTAXIS, CORREGIDO A LA FORMA SEGURA ---
