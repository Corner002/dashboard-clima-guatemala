...
st.markdown(
    ...
    <div style="text-align: center; margin-top: -10px; margin-bottom: 15px;">
        ...
        <a href="https://www.linkedin.com/in/jose-esquina-0350aa159" target="_blank" style="
            text-decoration: none; color: white; border: 1px solid #00f2ff; padding: 6px 18px; border-radius: 25px; font-weight: bold; display: inline-block; margin-bottom: 10px; transition: 0.3s;">
...
def plot_linea(data, x, y, titulo, color_hex):
    # CORRECCIÓN: Esta función ahora recibe datos mensuales (Mes_Nombre), 
    # por lo que Plotly usará automáticamente las categorías "Enero", "Febrero"...
...
with tab_resumen:
    ...
    if df_filtrado.empty:
        ...
        with col_top2:
            ...
            df_temp_mensual = df_filtrado.groupby(['Mes_Nombre'], observed=False)['Temp_Media'].mean().reset_index()
            st.plotly_chart(plot_linea(df_temp_mensual, 'Mes_Nombre', 'Temp_Media', "🌡️ Temperatura Media Mensual", "#ffe600"), use_container_width=True)
